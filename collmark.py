...
class collectmarks():
    ...
    def copymark(self, srcdir):
        ...
        self.allrowmark = []   # for store all row marks
        for t in self.classlist:
            ...
            for row in range(1,sheet.max_row):
                ...
                self.allrowmark.append(rowmark)      # add one row marks to form all row marks
...
#            logging.info(self.classmark)            
#        logging.info(self.classmark)   # data is too much to information                   
#        input('for debug 2')
...
def main():
    ...
    collmark.writestudent(STUDNUM,DSTDIR)
##
